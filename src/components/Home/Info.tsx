        ...
        <section
            ...
            <div className={'flex gap-2'}>
                <div className={'text-7xl flex text-white font-bold'}><span
                    className={'text-3xl flex items-center font-semibold md:text-5xl text-white'}>+</span>5
                </div>
            ...
            <div className={'flex gap-2'}>
                <div className={'text-7xl flex text-white font-bold'}><span
                    className={'text-3xl flex items-center font-semibold md:text-5xl text-white'}>+</span>20
                </div>
            ...
            <div className={'flex gap-2'}>
                <div className={'text-7xl flex text-white font-bold'}><span
                    className={'text-3xl flex items-center font-semibold md:text-5xl text-white'}>+</span>3
                </div>
