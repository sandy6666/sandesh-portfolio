...
const Hero = () => {
    return (
        <section className={'bg-[#121212] h-[860px]'}>
            <div className={'filter-invert h-full flex items-center'} style={{
                backgroundImage: `url('/background.png')`,
            }}>
                <div className={'w-full flex flex-col lg:w-3/4 px-10 md:px-28 gap-6'}>
                    <p className={'text-xl text-white filter-invert'}>👋 Hi there, I'm</p>
                    <h1 className={'text-7xl'}>Sandesh S</h1>
                    <p className={'text-xl text-[#575454]'}>I assist individuals and brands in achieving their
                        objectives by creating and developing user-focused digital products and interactive
                        experiences.</p>
                    <div>
                        <button
                            className={'w-[176px] h-[58px] text-sm font-bold rounded-xl text-white flex justify-center items-center gap-2 gradient-primary filter-invert'}> Download
                            CV <ArrowDownToLine/></button>
                    </div>
                    <div className={'text-xl text-[#575454]'}>+ 5 years with professional web development</div>
                    <div className={'flex gap-3'}>
                        <div className={'w-10 h-10 filter-invert'}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1129.16 1333.33"
                        ...
                        <div className={'w-12 h-12 filter-invert'}>
                            <Image src={'/docker-icon.svg'} alt={'docker-icon'} layout='fill' objectFit='contain'/>
                        </div>
                        <div className={'w-10 h-10 filter-invert'}>
                            <Image src={'/python.svg'} alt={'python'} layout='fill' objectFit='contain'/>
                        </div>
                    </div>
                </div>
            </div>
